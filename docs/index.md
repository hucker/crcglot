...
- **[Generated code style](generated-code.md)**: documentation-comment styles per language, naming conventions, provenance, and the embedded self-test.
...
- **[Verification](verification/index.md)**: the review model (review by evidence, not by reading), the ten-category verification matrix mapped to its tests, and the series of adversarial verification passes with findings and resolutions.
...
- **[EXAMPLES.md](../EXAMPLES.md)**: generated source in three tours, one per axis: every language, every implementation variant, every documentation style (auto-generated gallery).
