...
_register(
    VerbSpec(
        ...
        description=(
            ...
            "algorithm, variant) cell.  Supports C, C#, Go, Java, Lua, "
            "Python, Rust, TypeScript, Verilog, VHDL, Zig.  Variants: 'auto' (DEFAULT -- "
            ...
            "Rust / Go / Lua / Python / TypeScript / Verilog / VHDL / Zig; the "
            "public class name shown in the emitted code for Java / C#.  Large "
            "variants make "
