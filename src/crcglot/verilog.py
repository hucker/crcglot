...
def generate_verilog(
    ...
    if algo is None:
        return None
    return generate_verilog_from_entry(name, algo, table=table, symbol=symbol)
...
def generate_verilog_from_entry(
    ...
    Args:
        ...
        table: Accepted for API symmetry with the other generators
            but ignored -- bit-by-bit only (table-driven Verilog
            deferred, same scope decision as VHDL).
